...
export default async function BrandProductsPage({
  ...
  // Fetch brand details
  const brandResponse = await fetch(`${process.env.API_URL}/brands/${brandId}`);
    ...
    <div className="container mx-auto px-4 py-8">
      ...
      <div className="mb-8 flex items-center gap-6 bg-white p-6 rounded-lg shadow-sm">
        <div className="w-24 h-24 bg-gray-100 rounded-lg overflow-hidden shrink-0">
          <Image
            src={brandData.data?.image || "/placeholder.png"}
            alt={brandData.data?.name || "Brand"}
            width={96}
            height={96}
